...
func (r *stubRuntime) Execute(ctx context.Context, workDir string, prompt string, policy runtimepkg.ExecutionPolicy) (string, error) {
	return "", errors.New("not implemented")
}

func (r *stubRuntime) ExecuteStdin(ctx context.Context, prompt string, policy runtimepkg.ExecutionPolicy) (string, error) {
